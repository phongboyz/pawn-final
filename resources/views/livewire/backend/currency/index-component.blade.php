    ...
    <div class="row">
                ...
                <div id="cardCollpase1" class="collapse show">
                    <div wire:ignore.self>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{route('currency')}}" class="btn btn-danger">ລ້າງຂໍ້ມູນ</a>
        ...
        <div class="col-sm-8">
            <div class="card-box">
                            ...
                            <div class="table-responsive mb-0" data-pattern="priority-columns">
                                ...
                                <table border="2" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                        <tr class="text-center">
                                            <td colspan="8" style="color: #787878;">ບໍ່ມີຂໍ້ມູນສະກຸນເງິນ</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                ...
                <div class="row">
                    <div class="col-12">
                        <span><br> ລວມສະກຸນເງິນທັງໝົດ <span class="text-danger">{{$count}}</span> ລາຍການ</span>
                    </div>
                </div>
            </div>
        </div>
