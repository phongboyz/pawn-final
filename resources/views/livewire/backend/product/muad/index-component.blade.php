            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">ຂໍ້ມູນໝວດຫຼັກຊັບ</li>
                    </ol>
                </div>
                <h4 class="page-title">ຂໍ້ມູນໝວດຫຼັກຊັບ</h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="card-box">
                            ...
                            <div class="table-responsive mb-0" data-pattern="priority-columns">
                                ...
                                <table border="2" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                        <tr class="text-center">
                                            <td colspan="8" style="color: #787878;">ບໍ່ມີຂໍ້ມູນໝວດ</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                ...
                <div class="row">
                    <div class="col-12">
                        <span><br> ລວມໝວດທັງໝົດ <span class="text-danger">{{$count}}</span> ລາຍການ</span>
                    </div>
                </div>
            </div>
        </div>
